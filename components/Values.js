...
const Values = () => {
  return (
    <section id="values">
      <div id="A1" className="container mx-auto py-20 mt-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-16 py-20">
        <div className="flex flex-col gap-5 items-center">
          <Image src="/assets/val1.svg" alt="v1" width={100} height={100}/>
        ...
        <div className="flex flex-col gap-5 items-center">
          <Image src="/assets/val2.svg" alt="v1" width={100} height={100}/>
          ...
          <Image src="/assets/val3.svg" alt="v1" width={100} height={100}/>
